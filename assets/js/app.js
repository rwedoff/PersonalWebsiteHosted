var SimpleGame = (function () {
    ...
    SimpleGame.prototype.preload = function () {
        this.game.load.image('slime', '../images/mspGame/slimeWalk1.png');
        this.game.load.image('poker', '../images/mspGame/pokerMad.png');
        this.game.load.image('fly', '../images/mspGame/flyFly1.png');
        this.game.load.image('tile', '../images/mspGame/stoneMid.png');
        this.game.load.image('spikes', '../images/mspGame/spikes.png');
        this.game.load.spritesheet('playerSheet', '../images/mspGame/spritesheet.png', 72, 97, 11);
